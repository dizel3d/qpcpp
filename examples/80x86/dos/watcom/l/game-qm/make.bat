@echo off
:: ===========================================================================
:: "Fly 'n' Shoot" game, 80x86, Vanilla kernel, Open Watcom, QM-generated code
...
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\mine1.obj    %SRCDIR%\qm_code\mine1.cpp
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\mine2.obj    %SRCDIR%\qm_code\mine2.cpp
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\missile.obj  %SRCDIR%\qm_code\missile.cpp
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\ship.obj     %SRCDIR%\qm_code\ship.cpp
%CC% %CCFLAGS% %CCINC% -fo=%BINDIR%\tunnel.obj   %SRCDIR%\qm_code\tunnel.cpp
@echo off
