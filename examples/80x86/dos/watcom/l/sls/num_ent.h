...
private:
    static QState initial (NumEntry *me, QEvent const *e);
    static QState top     (NumEntry *me, QEvent const *e);
    static QState negative(NumEntry *me, QEvent const *e);
    static QState zero    (NumEntry *me, QEvent const *e);
    static QState integer (NumEntry *me, QEvent const *e);
    static QState fraction(NumEntry *me, QEvent const *e);
};
