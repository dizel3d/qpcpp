...
static MineEvt  const l_mine2_hit(HIT_MINE_SIG, 2);
static ScoreEvt const l_mine2_destroyed(DESTROYED_MINE_SIG, 45);
    ...
    switch (e->sig) {
        ...
        case MISSILE_IMG_SIG: {
                                   ...
                                   me->m_x, me->m_y, bmp, x, y))
            {
                ...
                AO_Missile->postFIFO(&l_mine2_destroyed);
